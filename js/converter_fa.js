$(document).ready(function () {
    ...
    $(".spans-result").find(".converted-currency1").html(spansToTooman_amount + " تومان");
    ...
    $(".paypal-result").find(".converted-currency1").html(paypaltoTooman_amount + " تومان");
